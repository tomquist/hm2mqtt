...
- Support the `VNSEMINI-X` device type (e.g. `VNSEMINI-0`): the Marstek Venus E Mini. Monitoring only. Beta: some values may be wrong and the sensors may still change (discussion #425)
